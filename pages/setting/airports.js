...
const Airports = () => {
  ...
  const { getAirports, postAirport, updateAirport, deleteAirport } =
    useAirportsHook({
      page,
      q,
    })
  ...
  const { data, isLoading, isError, error, refetch } = getAirports
  ...
  return (
    <>
      <Head>
        ...
        <meta property='og:title' content='Airports' key='title' />
      </Head>
...
export default dynamic(() => Promise.resolve(withAuth(Airports)), {
  ssr: false,
})
