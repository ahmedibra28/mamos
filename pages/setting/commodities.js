...
const Commodities = () => {
  ...
  const { getCommodities, postCommodity, updateCommodity, deleteCommodity } =
    useCommoditiesHook({
      page,
      q,
    })
  ...
  const { data, isLoading, isError, error, refetch } = getCommodities
  ...
  return (
    <>
      <Head>
        ...
        <meta property='og:title' content='Commodities' key='title' />
      </Head>
...
export default dynamic(() => Promise.resolve(withAuth(Commodities)), {
  ssr: false,
})
