...
const Air = () => {
  ...
  const USED_KG =
    USED_CAPACITY_ARRAY &&
    USED_CAPACITY_ARRAY.reduce((acc, curr) => acc + curr, 0)
  ...
  const movementTypes = {
    pickUp: ['Door to Door', 'Door to Airport'],
    dropOff: ['Door to Door', 'Airport to Door'],
  ...
  const submitHandler = (data) => {
    ...
    if (formStep > 8) {
      ...
      formData.append('destAirport', data.destAirport)
      ...
      formData.append('pickupAirport', data.pickupAirport)
      formData.append('transportationType', 'Plane')
            ...
            <div className='col-md-10 col-12 mx-auto'>
              ...
              {formStep > 1 && (
                ...
                >
                  <div className='row gx-2 my-2'>
                    ...
                    >
                      <FaSearch className='mb-1' /> Search Available Plane
                    </button>
              ...
              {formStep > 2 && (
                ...
                >
                  <div className='row gx-2 my-2'>
                    {availableShippers &&
                      availableShippers.filter((a) => a.cargoType === 'AIR')
                        ?.length === 0 && (
                            ...
                            <div className='card borer-0'>
                              ...
                              <div className='card-body'>
                                <div className='d-flex justify-content-between align-items-center'>
                                  ...
                                  >
                                    <FaPlane className='mb-1 fs-4' /> <br />
                                    {shipper.departureAirport.name} <br />
                                    <span
                                  ...
                                  >
                                    <FaPlane className='mb-1 fs-4' /> <br />{' '}
                                    {shipper.arrivalAirport.name} <br />
                                    <span
                                      className='fw-lighter'
                                      style={{ fontSize: '12px' }}
                                    >
                          ...
                          {inputFields.map((inputField, index) => (
                            <div key={index}>
                              ...
                              <div className='row gx-1 p-2'>
                                ...
                                <div className='col-md-4 col-12 mx-auto mt-2'>
                                  <button
                                    type='button'
                  ...
                  <div className='row gx-2 my-2'>
                    {selectedShipment && (
                      <div className='row gx-2 my-2'>
                        ...
                        {movementTypes.airport.includes(
                          watch().movementType
                        ) && (
                          <p>
                            You have selected airport to airport transportation,
