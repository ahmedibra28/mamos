...
const clientPermissions = [
  ...
  },
  {
    ...
    sort: 3,
    auth: true,
    description: 'Create FCL Bookings page',
  },
  {
    name: 'LCL Booking',
    path: '/orders/lcl',
    ...
    sort: 3,
    auth: true,
    description: 'Create LCL Bookings page',
  },
  {
...
const permissions = [
  ...
  {
    description: 'Create FCL Booking',
    route: '/api/orders/orders/fcl',
    auth: true,
    name: 'Bookings',
    method: 'POST',
  },
  {
    description: 'Create LCL Booking',
    route: '/api/orders/orders/lcl',
    auth: true,
    name: 'Bookings',
    method: 'POST',
  },
